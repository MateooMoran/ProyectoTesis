...
const Register = () => {
    ...
    return (
        <div className="flex flex-col sm:flex-row h-screen">
                ...
                <div className="w-full max-w-md">
                    ...
                    <form onSubmit={handleSubmit(registro)}>
                        ...
                        <div className="mb-3">
                            ...
                            />
                            {errors.telefono && <p className="text-red-800 text-xs">{errors.telefono.message}</p>}
                        </div>
                        ...
                        <div className="mb-3">
                            <button className="w-full py-2 my-5 bg-blue-900 text-white rounded-xl hover:scale-105 duration-300 hover:bg-red-700">
                                Registrarse
                            </button>
                        </div>
                    </form>
                    ...
                    <div className="mt-4 text-center text-sm">
                        ...
                        <Link to="/login" className="border-b-2 hover:text-red-700">
                            Iniciar Sesión
                        </Link>
                    </div>
                </div>
            ...
            <div
                className="hidden sm:block sm:w-1/2 h-screen bg-[url('/src/assets/imgRegister.jpg')] bg-no-repeat bg-cover bg-center"
            ></div>
        </div>
    );
}
