        ...
        <>
            ...
            <main className="py-10 bg-blue-50 min-h-screen">
                <div className="max-w-7xl mx-auto px-4">
                    <h2 className="text-3xl font-bold bg-gradient-to-r from-gray-700 to-gray-700 bg-clip-text text-transparent text-center mb-3 flex items-center justify-center gap-2">
                        <FileText size={34} />
                        Quejas y Sugerencias
                    </h2>
                    <p className="text-gray-500 text-center mb-12 max-w-2xl mx-auto">
                    Gestiona tus quejas y sugerencias.
                    </p>
