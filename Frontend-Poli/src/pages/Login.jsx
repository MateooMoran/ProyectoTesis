          ...
          <form onSubmit={handleSubmit(loginUser)} noValidate>
            <div className="mb-3">
              ...
              <input
                ...
                } focus:border-blue-700 focus:outline-none focus:ring-1 focus:ring-blue-700 py-1 px-2 text-gray-700`}
                {...register("email", {
            ...
            <div className="mb-3 relative">
              ...
              <div className="relative">
                <input
                  ...
                  } focus:border-blue-700 focus:outline-none focus:ring-1 focus:ring-blue-700 py-1 px-1.5 text-gray-700 pr-10`}
                  {...register("password", {
