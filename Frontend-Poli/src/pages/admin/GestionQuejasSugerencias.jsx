...
function GestionarQuejasSugerencias() {
    ...
    const responderQueja = async (id, respuesta) => {
        // Se quita setQuejas aquí para no actualizar localmente
    ...
    return (
        <div className="p-6 max-w-6xl mx-auto">
            <ToastContainer />
            <h2 className="text-2xl font-semibold mb-6  text-gray-500">Gestión de Quejas y Sugerencias</h2>
                        ...
                        {quejas.map((q) => (
                            ...
                            >
                                ...
                                <button
                                    ...
                                    className="bg-blue-800  text-white px-4 py-2 rounded-md text-sm font-semibold hover:bg-blue-700 transition"
                                >
                                    Guardar
                                </button>
                            </div>
