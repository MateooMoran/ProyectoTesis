...
import { aumentarCantidadProducto, crearCarrito, disminuirCantidadProducto, eliminarProductoCarrito, vaciarCarrito, visualizarCarrito } from "../controllers/estudiante/carritoController.js";
...
router.put('/estudiante/carrito/aumentar/:id', verifyTokenJWT, esEstudiante, aumentarCantidadProducto);
